    ...
    <SafeAreaView className="flex-1  bg-white">
      ...
      <View className="px-6 gap 2">
        <MenuItem
          ...
          onPress={() => router.push("/(root)/(tab)/saved")}
        />
        <MenuItem
        ...
        <MenuItem
          ...
          onPress={() =>
            Linking.openURL(
              "mailto:khanfaysal438@gmail.com?subject=Help%20%26%20Support%20-%20Kribb%20App",
            )
          }
        />
      </View>
...
function MenuItem({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      className="flex-row items-center gap-4 rounded-2xl px-4 py-4 border-gray-50"
    >
